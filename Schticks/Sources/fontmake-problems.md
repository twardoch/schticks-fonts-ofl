...
After I manually cleaned the offending portions in the `.glyphs` files using a text editor, and stored the font in [25-gly-mm-width1](25-gly-mm-width1), then run `fontmake` on it, I get:
